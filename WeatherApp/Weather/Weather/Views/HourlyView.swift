...
struct HourlyView: View {
        ...
        ScrollView(.horizontal, showsIndicators: false) {
            HStack(spacing: Constants.Dimensions.secondSpacing) {
                ForEach(weatherViewModel.weather.hourly) { weather in
                    ...
                    let icon = AsyncImage(url: URL(string: Constants.Strings.imageBaseUrl+selectedIcon+".png"))
    ...
    private func HourlyWeatherCell(hour: String, image: AsyncImage<some View>, temp: String) -> some View {
