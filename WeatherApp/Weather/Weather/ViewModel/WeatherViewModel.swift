...
class WeatherViewModel: NSObject,ObservableObject {
    ...
    private func saveLastSearchedLocation() {
        ...
        //For more security, would save it to keychain or use coredata for storing data.
    }
    ...
    private func getWeatherForLocation(coord: CLLocationCoordinate2D?) {
        ...
        if let coord = coord {
            ...
            urlString = WeatherApi.getCurrentWeatherURL(latitude: 19.0760, longitude: 72.8777) // Mumbai
        }
